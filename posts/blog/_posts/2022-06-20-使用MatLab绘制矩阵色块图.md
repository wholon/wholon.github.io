...
在毕业课程实践中，有需要绘制二维色块图的需求，参考这篇文章[**matlab绘制矩阵色块图**](https://blog.51cto.com/u_12355165/2782119)实现如下：

```matlab
 x = [0.6465    0.0319    0.0342
    0.2452    0.9186    0.0377
    0.1082    0.0495    0.9281];
XVarNames = {'消极','中性','积极'};
matrixplot(x,'FillStyle','fill','XVarNames',XVarNames,'YVarNames',XVarNames,'ColorBar','on');
...
if ~ismatrix(data) || ~isreal(data)
 ...
 xlabel("真实标签",FontSize=16,FontWeight="bold");
% 解析成对出现的参数名/参数值
...
![image-20220620163659943](https://holon-image.oss-cn-beijing.aliyuncs.com/20220620163700peqRYB.png)